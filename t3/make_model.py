...
def make_model():
  ...
  actions_m1 = tf.keras.layers.LeakyReLU()(actions_m1)
  actions_m1 = tf.keras.layers.GRU(1024, return_sequences=True)(actions_m1)
  ...
  actions_m5 = tf.keras.layers.LeakyReLU()(actions_m5)
  actions_m5 = tf.keras.layers.GRU(1024, return_sequences=True)(actions_m5)
  ...
  actions_m15 = tf.keras.layers.LeakyReLU()(actions_m15)
  actions_m15 = tf.keras.layers.GRU(1024, return_sequences=True)(actions_m15)
